...
Consider the circuit for proving the equality of the cumulative value of the input coins and the output coins in Section \ref{sec:application}. We assume that $\mathsf{rt}$ denotes the Merkle
