...
%\commentN{Is it necessary to state the point below? It's a bit vague. And if the MPC protocols are proven UC-secure, then I think sequential composition is fine. Can the complexity of a security proof be a parameter of interest?}
...
\UPDATED{The work DIZK \cite{dizk} provides a distributed implementation of proof generation to reduce proving time. There is no notion of privacy among the provers in this setting.}
