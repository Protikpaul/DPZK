...
%For most of the protocols, the communication cost among the provers is expensive. Our protocol $\name$ provides an efficient construction of the distributed prover version. Below we provide a construction of the compiler that takes an IOP-based proof system and outputs a secure IOP-based proof system. 
...
%		%----
%		\item $\prover'$ computes $\pi'_i = \comm(\CK, \pi_i)$. %and $\omega[k]$ is the randomness used for the commitment.
%		%----
