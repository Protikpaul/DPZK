...
\newcommand{\dpname}{\text{D-Graphene}}
%\newcommand{\npol}{\ensuremath{\msthsf{NP}}}
%------------------------------------
...
\def\Num{\mathsf{D}} % number of provers
...
\def\distinguisher{\mathcal{D}} %Distinguisher
\def\ppt{\mathsf{PPT}}
...
\newcommand{\honshr}[1]{\langle{#1}\rangle^H}
\newcommand{\corshr}[1]{\langle{#1}\rangle^C}
\newcommand{\Pip}{\mathsf{p}_{ip}}
...
\newcommand{\commentN}[1]{\textcolor{cyan}{{\sf (Nitin's Note:} {\sl{#1}} {\sf EON)}}}
%---------------
\else
...
%\newcommand{\CHANGED}[1] {\textcolor{darkred} {#1}}
\newcommand{\UPDATED}[1] {\textcolor{darkgreen} {#1}}
\else
\newcommand{\ADDED}[1] {\normalcolor #1}
\newcommand{\CHANGED}[1] {\normalcolor #1}
\newcommand{\UPDATED}[1] {\normalcolor #1}
...
\newcommand{\FMult}{\ensuremath{\calF_{\sf Mult}}}
\newcommand{\shareA}[1]{\ensuremath{\langle #1 \rangle}}
\newcommand{\shareM}[1]{\ensuremath{[#1]}}
\newcommand{\SimV}{\ensuremath{\mathsf{S View}}}
\newcommand{\RealV}{\ensuremath{\mathsf{R View}}}
\newcommand{\disPN}{\ensuremath{\mathsf{Dist}(\Partyset, \Num)}}
\newcommand{\disPpN}{\ensuremath{\mathsf{Dist}(\Partyset', \Num)}}	
\newcommand{\disPpAN}{\ensuremath{\mathsf{Dist}(\Partyset'^\ast, \Num)}}
\newcommand{\FC}{\ensuremath{\mathsf{FC}}}
