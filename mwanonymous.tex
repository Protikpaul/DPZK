...
\UPDATED{Similarly, for auctions using cryptocurrencies, where a set of users can place joint bids, we may leverage DPZK to produce a proof that they together own coins amounting to the submitted bid.}
