...
\end{itemize}
By verifying the above zero knowledge proof, \commentA{what is a network? Please avoid such undefined entitites}the network ensures that serial numbers correspond to coins that were legitimately created and by further
