...
being honest ~\cite{trinocchio}. The goal of this paper is to address the aforementioned shortcomings and enable DPZK for more general appilcations. We describe a few real-world applications below:
