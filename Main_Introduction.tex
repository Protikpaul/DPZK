...
\commentA{the following sentence construction is not correct} 
{\color{blue}
...
\begin{itemize}
	...
	%----------
	\item \commentA{wrong/fishy sentence construction. compiling twice? what are the compilers? clean up the sentence}.
	\commentN{I am replacing brown with blue: There was another issue, Graphene does not achieve DPZK, it can be turned into something (D-Graphene)
	which achieves DPZK. We should take care of this other places also.}
	{\color{brown}
	Finally, we produce a protocol, \name,  \commentA{is it graphene or Dgraphene}obtained via compiling a Ligero-style proof system using our compiler. 
	...
	\commentN{I don't think the paragraph below is needed. Indeed, one of the referees asked to remove justification for
	our assumptions, and simply state them}.
	%----------
	{\color{brown}
